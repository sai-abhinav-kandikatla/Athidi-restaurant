-- Canonical production schema. Followed by additive security hardening below.
...
-- Additive API, token, RBAC, rate-limit, and audit hardening.
...
begin
  ...
  if target_order.status in ('PAID', 'CANCELLED') then
