    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lede">From slow-sealed biryanis to recipes passed down through generations, every plate at Athidi is a warm invitation to stay a little longer.</p>
          ...
          <div className="hero-visual">
            <div className="hero-image" role="img" aria-label="Athidi signature dum biryani" />
            <div className="hero-special">
              <span>Chef&apos;s signature</span>
              <strong>{signature?.name ?? "Athidi family favourites"}</strong>
      ...
      <section className="story-section" id="story">
        <div className="container story-grid">
          ...
          <div className="story-copy">
            ...
            <h2>In Telugu, <em>Athidi</em><br />means guest.</h2>
      ...
      <section className="reviews-section" id="reviews">
        <div className="container reviews-grid">
          ...
          <blockquote><div className="quote-mark">“</div><p>Every guest deserves honest food, generous hospitality and a team that listens. That is the standard we work toward at every service.</p><footer><div className="avatar">A</div><div><strong>The Athidi team</strong><span>Our service promise</span></div></footer></blockquote>
        ...
        <div className="container visit-card">
          <div className="visit-copy">
            ...
            <div className="visit-details">
              <div><MapPin /><span><strong>{data.restaurant?.name ?? "Athidi Family Restaurant"}</strong><small>{data.branch?.address ?? "Visit us for a warm family meal"}</small></span></div>
          ...
          <div className="map-art"><div className="map-pin"><MapPin size={28} /></div><span className="road road-1" /><span className="road road-2" /><span className="road road-3" /><div className="map-label"><Brand compact /><span>Athidi Family Restaurant</span></div></div>
        </div>
      </section>
      ...
      <footer className="site-footer">
        ...
        <div className="container footer-bottom"><span>© 2026 Athidi Family Restaurant</span><span>అతిథి దేవో భవ</span></div>
      </footer>
    </main>
  );
}
